...
## Project Structure
    ...
    ├── testapiautosetting_125102  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125102`
...
2. Clone this repo and `cd testapiautosetting_125102`
